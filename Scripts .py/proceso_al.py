...
path= 'Z:\Proyecto visores\Data Información Colombia\Peru\DATA Cliente\Arcangel\\'
...
if os.path.exists(unicode(path_so, "utf-8")):
    #modificando ktr
    ktr= dir_ktr + r'sell_out_albis.ktr'
    replace_ktr(ktr,path_so)
    ktr= dir_ktr + r'stock_albis.ktr'
    replace_ktr(ktr,path_st)
    #ejecutando job
    call(dir_bat + r'sellout_al_kjb.bat')
    call(dir_bat + r'stock_al_kjb.bat')
else:

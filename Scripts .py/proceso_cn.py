...
file_so='{0}{1}\\Semana {2}\\{3}_{4}_{5}_Continental_SellOut.xlsx'
file_st='{0}{1}\\Semana {2}\\{3}_{4}_{5}_Continental_Inventario.xlsx'
path= 'Z:\Proyecto visores\Data Información Colombia\Peru\DATA Cliente\Continental\\'
...
if os.path.exists(unicode(path_so, "utf-8")):
    #modificando ktr
    ktr= dir_ktr + r'sell_out_continental.ktr'
    replace_ktr(ktr,path_so)
    ktr= dir_ktr + r'stock_continental.ktr'
    ...
    #ejecutando job
    call(dir_bat + r'sellout_cn_kjb.bat')
    call(dir_bat + r'stock_cn_kjb.bat')
else:

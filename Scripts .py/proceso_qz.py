...
def get_time(fecha):
    timefile=r'D:\Python lab\tiempo.csv'
...
file_so='{0}{1}\\Semana {2}\\{3}_{4}_{5}_QZ_SellOut.txt'
file_st='{0}{1}\\Semana {2}\\{3}_{4}_{5}_QZ_Inventario.txt'
path= 'Z:\Proyecto visores\Data Información Colombia\Bolivia\DATA Cliente\Quimiza\\'
...
if os.path.exists(unicode(path_so, "utf-8"))and os.path.exists(unicode(path_st, "utf-8")):
    #modificando ktr 4
    ktr=r'D:\Pentaho lab\sell_out_quimiza.ktr'
    replace_ktr(ktr,path_so)
    ktr=r'D:\Pentaho lab\stock_quimiza.ktr'
    ...
    #ejecutando job
    call("D:\Python lab\sellout_qz_kjb.bat")
    call("D:\Python lab\stock_kjb.bat")
else:

DELETE FROM mkt.SELLOUT_CENCO_HISTW
WHERE Fecha in
(SELECT DISTINCT CONCAT(SUBSTRING(PERIODO,1,4),SUBSTRING(PERIODO,6,2),SUBSTRING(PERIODO,9,2)) FROM mkt.sellout_cc_day A)
;

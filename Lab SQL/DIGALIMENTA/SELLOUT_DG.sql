DROP TABLE  mkt.SELLOUT_DIGA_HISTW;
SELECT
...
A.CANTIDAD,
A.VALORVTA
INTO mkt.SELLOUT_DIGA_HISTW
FROM [genomma].[mkt].[SELLOUT_DIGA_HIST] A
...
cast(TIPO_CLIENTE as varchar(4)) [GrupoTratIDClie],
cast(A.COD_VEND as varchar(7)) [VendedorIDClie],
cast(A.COD_SUPER as varchar(8)) [SupervisorIDClie],
cast(convert(int,A.COD_PROD)  as varchar(12)) [ProIDClie],
cast(convert(int,A.COD_CLIENTE) as varchar(8)) [PdvIDClie],
cast(A.CANTIDAD as decimal(18,6)) [UnidDesp],
cast(A.VALORVTA as decimal(18,6)) [MontoDespCliente]
--into mkt.sellout_stage
FROM mkt.SELLOUT_DIGA_HISTW A;

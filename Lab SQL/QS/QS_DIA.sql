...
SELECT max(a.VBRK_FKDAT) FROM [mkt].[SELLOUT_QS_HIST] a


SELECT * FROM mkt.stock_qui_suiza_day
...
,[Codigo_SAP]
      ...
      ,[UNIDAD_MEDIDA]
      ,[FEC_VCMTO_LOTE]
	  INTO mkt.stock_qui_suiza_dayc
FROM [genomma].mkt.stock_qui_suiza_day

DELETE FROM  mkt.STOCK_SPP_HISTW
WHERE FECHA IN (
	SELECT DISTINCT substring(FECHA,1,4)+substring(FECHA,6,2)+substring(FECHA,9,2) FECHA	FROM mkt.stock_sp_day A
);

INSERT INTO mkt.STOCK_SPP_HISTW
SELECT

DELETE FROM MKT.SELLOUT_KEYMARK_HISTW
WHERE FECHA in
      (SELECT DISTINCT SUBSTRING(A.FECHA,7,4)+SUBSTRING(A.FECHA,4,2)+ SUBSTRING(A.FECHA,1,2) FROM mkt.sellout_km_day A);

INSERT INTO mkt.SELLOUT_KEYMARK_HISTW
SELECT

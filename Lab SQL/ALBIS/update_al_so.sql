DELETE FROM mkt.SELLOUT_ALBIS_HISTW
WHERE Fecha in
(SELECT DISTINCT CONCAT(SUBSTRING(Fecha,1,4),SUBSTRING(Fecha,6,2),SUBSTRING(Fecha,9,2)) FROM mkt.sellout_al_day A)
;

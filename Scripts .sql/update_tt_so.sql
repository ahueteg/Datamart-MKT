DELETE FROM mkt.SELLOUT_TOTTUS_HISTW
WHERE Fecha in
(SELECT DISTINCT SUBSTRING(RTRIM(LTRIM(FECHA)),1,8) FECHA FROM mkt.sellout_tt_day A)
;

INSERT INTO mkt.SELLOUT_TOTTUS_HISTW
SELECT
...
cast(convert(bigint,A.COD_PROD)  as varchar(13)) [ProIDClie],
cast(A.COD_PDV as varchar(13)) [PdvIDClie],
